        ...
        <footer className="border-t border-border bg-card">
            <div className="mx-auto grid max-w-[1440px] gap-10 px-4 py-12 sm:px-6 lg:grid-cols-4">
                <div className="space-y-3">
                    ...
                    <p className="text-sm leading-7 text-muted-foreground">
                        شهراز‌گلد پلتفرمی حرفه‌ای برای مشاهده شفاف قیمت طلا و سکه و مدیریت آسان حساب
                        کاربری، طراحی‌شده برای فعالان بازار طلا.
                    </p>
                ...
                <div id="contact">
                    ...
                    <ul className="space-y-3 text-sm text-muted-foreground">
                        <li className="flex items-start gap-2">
                            ...
                            <span>{toPersianDigits("021-33944597")}</span>
                        </li>
                        <li className="flex items-start gap-2">
                            <MapPin className="mt-0.5 h-4 w-4 text-[color:var(--gold-dark)]" />
                            <span>
                                تهران، خیابان جمهوری، روبه‌روی باغ سپهسالار، پلاک{" "}
                                {toPersianDigits(234)}
                            </span>
                        </li>
                    </ul>
            ...
            <div className="border-t border-border">
                <div className="mx-auto flex max-w-[1440px] flex-col items-center justify-between gap-2 px-4 py-4 text-xs text-muted-foreground sm:flex-row sm:px-6">
                    <span>
                        © {toPersianDigits(new Date().getFullYear())} شهراز‌گلد. تمامی حقوق محفوظ
                        است.
                    </span>
