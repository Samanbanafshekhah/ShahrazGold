...
$allowedOrigins = array_values(array_filter(array_map(function (string $origin): string {
    $origin = trim($origin);
    if ($origin === '*' || $origin === '') {
        return $origin;
    }

    return parse_url(str_contains($origin, '://') ? $origin : "//{$origin}", PHP_URL_HOST) ?: $origin;
...
return [
    ...
    'servers' => [
        'reverb' => [
            ...
            'scaling' => [
                ...
                'channel' => env('REVERB_SCALING_CHANNEL', 'shahrazgold-reverb'),
                'server' => [
                    'url' => env('REDIS_URL'),
    ...
    'apps' => [
        ...
        'apps' => [[
            ...
            'activity_timeout' => env('REVERB_APP_ACTIVITY_TIMEOUT', 20),
